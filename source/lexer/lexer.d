...
class Lexer
{
    ...
    this(string text, int offset)
    {
        ...
        while (_idx < text.length)
        {
            ...
            if (isWhite(peek())) // Skip whitespaces
            {
                next();
                continue;
            }
            ...
            case '+':
                if (next() == '=')
                {
                    tokens ~= new Token(TokType.PluEqu, "+=", line);
                    _idx++;
                }
                else
                    tokens ~= new Token(TokType.Plus, "+", line);
                break;
            ...
            case '-':
                ...
                if (n == '=')
                {
                    tokens ~= new Token(TokType.MinEqu, "-=", line);
                    _idx++;
                }
                else if (n == '>')
                {
                    tokens ~= new Token(TokType.SlicePtrOper, "->", line);
                    _idx++;
                }
                else
                    tokens ~= new Token(TokType.Minus, "-", line);
                break;

            case '*':
                if (next() == '=')
                {
                    tokens ~= new Token(TokType.MulEqu, "+=", line);
                    _idx++;
                }
                else
                    tokens ~= new Token(TokType.Multiply, "*", line);
                break;
            ...
            case '&':
                if (next() == '&')
                {
                    ...
                    tokens ~= new Token(TokType.GetPtr, "&", line);
                break;
            ...
            case '|':
                ...
                if (_n == '|')
                {
                    ...
                    tokens ~= new Token(TokType.BitOr, "|", line);
                break;
            ...
            case '{':
                tokens ~= new Token(TokType.Rbra, "{", line);
                next();
                break;

            case '}':
                tokens ~= new Token(TokType.Lbra, "}", line);
                next();
                break;

            case '[':
                tokens ~= new Token(TokType.Rarr, "[", line);
                next();
                break;

            case ']':
                tokens ~= new Token(TokType.Larr, "]", line);
                next();
                break;

            case ',':
                tokens ~= new Token(TokType.Comma, ",", line);
                next();
                break;

            case ':':
                tokens ~= new Token(TokType.ValSel, ":", line);
                next();
                break;

            case '%':
                tokens ~= new Token(TokType.Rem, "%", line);
                next();
                break;
            ...
            case '@':
                string bbuff = "";
                next();
                while (!isNumeric(to!string(peek()))
                    && peek() != '.'
                    && peek() != '+'
                    && peek() != '-'
                    && peek() != '*'
            ...
            case '.':
                ...
                if (n == '.')
                {
                    ...
                    if (n == '.')
                    {
                        tokens ~= new Token(TokType.VarArg, "...", line);
                        _idx++;
                        break;
                    }
                    tokens ~= new Token(TokType.SliceOper, "..", line);
                    break;
                }
                tokens ~= new Token(TokType.Dot, ".", line);
                break;
                    ...
                    if (n == 'h')
                    {
                        ...
                        if (n == 'i')
                        {
                            ...
                            if (n == 's')
                            {
                                n = next();
                                if (n != '.')
                                    tokens ~= new Token(TokType.Identifier, "~this", line);
                                else
                                {
                                    tokens ~= new Token(TokType.Destructor, "~", line);
                                    _idx -= 4;
                                }
                            }
                            else
            ...
            case '/':
                ...
                if (divnext == '*')
                {
                    ...
                    tokens ~= new Token(TokType.Divide, "/", line);
                break;
            ...
            case '>':
                ...
                if (rnext == '=')
                {
                    tokens ~= new Token(TokType.MoreEqual, ">=", line);
                    _idx++;
                    break;
                }
                if (rnext == '.')
                {
                    tokens ~= new Token(TokType.BitRight, ">>", line);
                    _idx++;
                    break;
                }
                tokens ~= new Token(TokType.More, ">", line);
                break;
            ...
            case '<':
                ...
                if (lnext == '=')
                {
                    tokens ~= new Token(TokType.LessEqual, "<=", line);
                    _idx++;
                }
                else if (lnext == '.')
                {
                    tokens ~= new Token(TokType.BitLeft, "<<", line);
                    _idx++;
                }
                else
                    tokens ~= new Token(TokType.Less, "<", line);
                break;
            ...
            case '=':
                ...
                if (peek() == '=')
                {
                    tokens ~= new Token(TokType.Equal, "==", line);
                    _idx++;
                }
                else if (peek() == '>')
                {
                    tokens ~= new Token(TokType.ShortRet, "=>", line);
                    _idx++;
                }
                else
                {
            ...
            case '!':
                ...
                if (_n == '=')
                {
                    tokens ~= new Token(TokType.Nequal, "!=", line);
                    _idx++;
                }
                else if (_n == '.')
                {
                    ...
                    tokens ~= new Token(TokType.Ne, "!", line);
                break;

            case ';':
                tokens ~= new Token(TokType.Semicolon, ";", line);
                _idx++;
                break;
            ...
            default:
                if (isDigit(cast(dchar) peek()))
                {
                    ...
                    if (!isFloat)
                    {
                        ...
                        tokens ~= new Token(TokType.Number, buffernum, line);
                        break;
                    }
                    tokens ~= new Token(TokType.FloatNumber, buffernum, line);
                    break;
                }
                ...
                else
                {
                    ...
                    case "namespace":
                    case "with":
                        tokens ~= new Token(TokType.Command, toLower(bufferiden));
                        break;
                    default:
                        tokens ~= new Token(TokType.Identifier, bufferiden, line);
                        break;
                    }
                }
                break;
